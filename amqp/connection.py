...
class Connection(AbstractChannel):
    ...
    def __init__(self, host='localhost', userid='guest', password='guest',
        ...
        #
        self.transport = self.Transport(host, connect_timeout, kwargs.get('write_timeout'), kwargs.get('read_timeout'), ssl)
    ...
    def Transport(self, host, connect_timeout, write_timeout, read_timeout, ssl=False):
        return create_transport(host, connect_timeout, write_timeout, read_timeout, ssl)
