...
class _AbstractTransport(object):
    ...
    def __init__(self, host, connect_timeout, write_timeout, read_timeout):
        self.connected = True
        msg = None
        port = AMQP_PORT
...
class SSLTransport(_AbstractTransport):
    ...
    def __init__(self, host, connect_timeout, write_timeout, read_timeout, ssl):
...
def create_transport(host, connect_timeout, write_timeout, read_timeout, ssl=False):
    """Given a few parameters from the Connection constructor,
    select and create a subclass of _AbstractTransport."""
    if ssl:
        return SSLTransport(host, connect_timeout, write_timeout, read_timeout, ssl)
    else:
